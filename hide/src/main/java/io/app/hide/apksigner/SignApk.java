    ...
    private Manifest addDigestsToManifest(JarFile jar)
        ...
        for (JarEntry entry : byName.values()) {
            ...
            if (!entry.isDirectory() &&
                ...
                attr.putValue("SHA1-Digest", new String(Base64.getEncoder().encode(md_sha1.digest()), "ASCII"));
...
//        }
    ...
    private byte[] writeSignatureFile(Manifest manifest, OutputStream out)
        ...
        print.flush();
        main.putValue("SHA1-Digest-Manifest", new String(Base64.getEncoder().encode(md.digest()), "ASCII"));
        ...
        for (Map.Entry<String, Attributes> entry : entries.entrySet()) {
            ...
            sfAttr.putValue("SHA1-Digest-Manifest",
                    new String(Base64.getEncoder().encode(md.digest()), "ASCII"));
